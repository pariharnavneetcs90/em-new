...
export default function Nagivation() {
  ...
  const { jwt: authJwt, user } = useSelector((state) => state.auth);
  ...
  return (
    <div className="bg-white mt-[20px] pb-[50px]">
